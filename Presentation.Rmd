...
```{r}
ggplot(president_group, aes(year, votes, fill = party_simplified)) + 
  geom_col(position = 'fill') + 
  scale_x_continuous(n.breaks = 12) +
  xlab("Election Year") + 
  ylab("Proportion Out of All Votes") +
  labs(title = "1976-2020 Presidential Elections Proportions of Total Votes Per Party", color = "Presidential Party") + 
  theme(legend.position = "bottom")
theme_linedraw()
```

For my second data set, I made a visualization showing the proportion of total votes that each presidential party received in each US election from 1976 to 2020. This shows that the vast majority of votes in each election have been for the Republican and Democrat parties, with each receiving a similar proportion of about 50% of votes in each election. The election varying the most from this trend was a the 1992 election, in which we can see that about 20% of votes were given to a candidate not in any of the
three main parties, resulting in the Democrats receiving the smallest proportion of total votes and the Republicans receiving nearly the smallest proportion of total votes that they have received in any election in this span of years.
